...
class OrderAct : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var url="http://192.168.29.155/Salesweb/get_temp.php?mobile="+UserInfo.mobile
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        {
            var url="http://192.168.29.155/Salesweb/cancel_order.php?mobile="+UserInfo.mobile
        ...
        if(item?.itemId==R.id.item_confirm){
            ...
            var U="http://192.168.29.155/Salesweb/confirm_order.php?mobile="+UserInfo.mobile

            var rq:RequestQueue=Volley.newRequestQueue(this)
            var sr= StringRequest(Request.Method.GET,U, Response.Listener { response->
